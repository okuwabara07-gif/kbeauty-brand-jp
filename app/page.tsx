  ...
  return (
    <>
      <section className="hero">
        <p className="hero-eyebrow">K-Beauty Brand</p>
        <h1 className="hero-title">K-Beautyを、もっと深く知る。</h1>
        <p className="hero-sub">COSRX・LANEIGE・innisfreeなど人気K-Beautyブランドの最新情報をお届けします。</p>
