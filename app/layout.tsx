...
export const metadata: Metadata = {
  title: { default: 'K-Beautyブランド', template: '%s | K-Beautyブランド' },
  description: 'K-Beautyブランドの最新情報とおすすめ商品を紹介',
        ...
        <header className="site-header">
          <div className="header-inner">
            <a href="/" className="site-logo">
              ...
              <span className="logo-text">K-Beautyブランド</span>
            </a>
